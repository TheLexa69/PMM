...
//require '../PHPMailer/SMTP.php';
 ...
 /*
 //mails("cambes6@gmail.com","Gabriel",123456);
    //novoluachea@gmail
function mails($email,$nombre,$token){
...
try {
   ...
   // $mail->SMTPDebug = SMTP::DEBUG_SERVER;                      //Enable verbose debug output
    ...
    //Recipients
    $mail->setFrom('restaurante@b01.daw2d.iesteis.gal', 'NovoLuaChea');     //Desde donde se envia
    $mail->addAddress("cambes6@gmail.com", "Gabriel");     //A quien se envia
    //$mail->addAddress('ellen@example.com');               //Name is optional
    //$mail->addReplyTo('info@example.com', 'Information');
   // $mail->addCC('cc@example.com');
    //$mail->addBCC('bcc@example.com');
    ...
    $mail->isHTML(true);                                  //Set email format to HTML
    $mail->Subject = 'Mensaje de verificacion cuenta';
    $mail->Body    = 'Valla a la pagina y ponga este codigo </b> 123456';
   // $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';    //mensaje alternativo
